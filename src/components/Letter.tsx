        ...
        {!isOpen ? (
          <Card className="bg-secondary/50 backdrop-blur-sm border-2 border-secondary shadow-xl animate-float relative overflow-hidden">
            <CardContent className="p-8 flex flex-col items-center relative z-10">
              ...
              <Flower className="h-16 w-16 text-primary mb-6 relative z-10" />
              <h3 className="text-2xl font-bold text-center mb-6 relative z-10">
                A note for you
              </h3>
              <Button 
                onClick={handleOpen} 
                className="px-8 py-6 text-lg relative z-10"
              >
                Open Note
              </Button>
            </CardContent>
          ...
          <Card className="bg-white p-8 shadow-xl animate-scaleIn">
            <CardContent className="p-4">
              <div className="bg-[url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80')] bg-cover bg-center h-48 -mt-4 -mx-4 mb-6 rounded-t-lg opacity-90" />
